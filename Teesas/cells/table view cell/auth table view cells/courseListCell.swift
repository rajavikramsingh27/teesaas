...
extension courseListCell: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    @objc func selectCell(_ sender:UIButton){
        ...
        NotificationCenter.default.post(name: NSNotification.Name("reloadTable"), object: selctedIndex,userInfo: ["val":allArr])
    }
