...
class ReportPageViewController: UIPageViewController, UIPageViewControllerDelegate,UIPageViewControllerDataSource {
    ...
    override func viewDidLoad() {
        ...
        let p1: UIViewController! = storyboard?.instantiateViewController(withIdentifier: "peformanceViewController") as! peformanceViewController
        let p2: UIViewController! = storyboard?.instantiateViewController(withIdentifier: "GrowthViewController") as! GrowthViewController
    ...
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool)
    {
        ...
        NotificationCenter.default.post(name: Notification.Name("get_offset_set_view"), object: index!)        
